...
void programLoop(void) {
    ...
    uint16_t input = (uint16_t)(!PORTBbits.RB1 << 8) | (uint16_t)(!PORTBbits.RB0 << 7) |
                     (uint16_t)(!PORTBbits.RB5 << 5) | (uint16_t)(!PORTBbits.RB4 << 4) |
                     (uint16_t)(!PORTBbits.RB3 << 2) | (uint16_t)(!PORTBbits.RB2 << 1);
